...
// // creator and user verify
// const allowedUserAndCreator = async (req, res, next) => {
//   if (req.user.role !== "user" && req.user.role !== "creator") {
...
async function run() {
  try {
    ...
    // feature post
    app.post("/api/features", verifyToken, adminVerify, async (req, res) => {
    ...
    // warning related
    app.post("/api/warnings", verifyToken, adminVerify, async (req, res) => {
